import type { BibleVersion, BibleBook, GitaVersion, GitaChapter } from './Types';
...
export const bibleBooks: BibleBook[] = [
  ...
  { "id": "JOB", "name": "Job", "url": "https://bible-api.com/data/kjv/JOB" },
  {
    "id": "PSA",
    "name": "Psalms",
...
export const gitaVersions: GitaVersion[] = [
  { id: 'kjv', name: 'King James Version' },
  { id: 'bbe', name: 'Bible in Basic English' },
  { id: 'oeb', name: 'Open English Bible' },
  { id: 'web', name: 'World English Bible' },
